...
export async function sendEmailProposta({
  ...
  try {
    ...
    if (status === 'recebido') {
      sendSmtpEmail.subject = "Recebemos sua ideia para as Marinas! 💡";
      sendSmtpEmail.htmlContent = `
        <div style="font-family: Arial, sans-serif; color: #1a202c; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px;">
          <h2 style="color: #00A86B;">Olá, ${nome}!</h2>
          ...
          <div style="background-color: #f7fafc; padding: 15px; border-left: 4px solid #00A86B; border-radius: 4px; margin: 20px 0;">
          ...
          <p style="text-align: center; margin: 25px 0;">
            <a href="${url}" style="background-color: #00A86B; color: white; padding: 12px 24px; text-decoration: none; border-radius: 30px; font-weight: bold; display: inline-block;">Acompanhar Minha Ideia →</a>
          </p>
      ...
      sendSmtpEmail.subject = "Sua ideia está no ar! Hora de mobilizar apoios 🎉";
      sendSmtpEmail.htmlContent = `
        <div style="font-family: Arial, sans-serif; color: #1a202c; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px;">
          <h2 style="color: #00A86B;">Olá, ${nome}!</h2>
          ...
          <p style="text-align: center; margin: 25px 0;">
            <a href="${url}" style="background-color: #00A86B; color: white; padding: 12px 24px; text-decoration: none; border-radius: 30px; font-weight: bold; display: inline-block;">Ver Minha Proposta Publicada</a>
          </p>
      ...
      sendSmtpEmail.subject = "Atualização sobre a sua proposta no Suas Ideias";
      sendSmtpEmail.htmlContent = `
        <div style="font-family: Arial, sans-serif; color: #1a202c; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px;">
          ...
          <p style="text-align: center; margin: 25px 0;">
            <a href="https://marinasporsp.com.br/suasideias" style="background-color: #3182ce; color: white; padding: 12px 24px; text-decoration: none; border-radius: 30px; font-weight: bold; display: inline-block;">Enviar Nova Proposta</a>
          </p>
