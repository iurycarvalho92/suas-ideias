...
export default function EstrelaMarinaHelou({ className = "w-6 h-6" }: SvgProps) {
  return (
    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      {/* Estrela de 8 pontas orgânica Marina Helou em Laranja (#F1891D) */}
      <path
      ...
      <path
        ...
        opacity="0.8"
      />
      <circle cx="50" cy="50" r="7" fill="#8C1A13" />
    </svg>
  );
}
