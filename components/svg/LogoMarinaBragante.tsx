...
export default function LogoMarinaBragante({ variant = 'vinho', className = "h-10" }: LogoProps) {
  const textColor = variant === 'creme' ? '#FFF6D5' : '#8C1A13';
  const accentColor = '#4F6219';
  ...
  return (
    <div className={`inline-flex items-center gap-2 font-serif font-bold ${className}`}>
      ...
      <div className="flex flex-col leading-none">
        ...
        <span className="text-[10px] font-sans font-bold tracking-wider text-[#4F6219] uppercase">
